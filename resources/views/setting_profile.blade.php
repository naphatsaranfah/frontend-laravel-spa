        ...
        <div class="container-setting-profile">
            ...
            <div class="relative">
                <a href="{{ url('/reserve_spa') }}">
                    ...
                    <img class="p-1 rounded-lg shadow-md bg-white  lg:w-40 lg:h-40 md:w-36 md:h-36  sm:w-36 sm:h-36 absolute text-5xl text-fuchsia-950 bottom-5  lg:left-40 lg:top-64 md:left-40 md:top-64 sm:left-20 sm:top-64 -translate-x-1/2 -translate-y-1/2"
                        src="./images/woman.png" />

                    <div class=" flex lg:ml-64 md:ml-64 sm:ml-44 mt-5">
                        <p class="username "> Naphatsaran Intewa</p>
                    </div>

                    <div class=" flex lg:ml-64 md:ml-64 sm:ml-44 mt-2 ">
                ...
                <div class="p-5 rounded-lg shadow-md hidden tab-bbb">
                    <div class="px-20 py-5 flex-auto">
                        <div class="tab-content tab-space">
                            ...
                            <div class="container-btn-next">
                                <a href="setting_show_add_other_recipients" class="button btn-next">บันทึก</a>
                            </div>
