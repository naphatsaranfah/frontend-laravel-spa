...
<body>
    <header>
        ...
        ">
                ...
                <div class="hidden w-full md:flex md:items-center md:w-auto">
                    ...
                    <div class=" flex flex-wrap items-center gap-5">
                        <div class="flex gap-2">
                            ...
                            <p class="text-sm text-fuchsia-950 font-ibm font-semibold">ถ.สุขุมวิท กรุงเทพมหานคร</p>
                        </div>
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <p class="text-sm text-fuchsia-950 font-ibm font-semibold">email@gmail.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden w-full md:flex md:items-center md:w-auto " id="">
                    <div class="flex gap-2 md:p-4 py-2 ">
                        ...
                        <div class="flex">
                            <button
                                ...
                                <p class="text-sm text-fuchsia-950 font-ibm font-semibold">ไทย</p>
                                ...
                                <div
                                    ...
                                    <div class="text-left flex relative">
                                        <div class="group relative flex  rounded-lg p-1 hover:bg-gray-50">
                                            ...
                                            <div>
                                                <a href="#" class="text-sm text-fuchsia-950 font-ibm font-semibold">
                                                    English
                    ...
                    <div class="flex gap-2 md:p-4 py-2 ">
                        ...
                        <p class=" text-fuchsia-950 text-sm font-ibm font-semibold">062-0683387</p>
                    </div>
                </div>
            </nav>
        ...
        ">
                <div>
                    <a class="flex gap-5" href="{{ url('/home') }}">
                        <svg class="fill-fuchsia-950" width="30" height="30" viewBox="0 0 20 19"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <p class="text-fuchsia-950 font-bold text-xl">Lirena</p>
                    </a>
                </div>
                        ...
                        <li class="mt-3 ">
                            ...
                            <div class=" hidden mt-2  bg-white shadow-md rounded-xl p-4 my-3 absolute "
                                ...
                                <div class="hover:bg-purple-100 px-3 py-1 rounded-xl cursor-pointer">
                                    <a class="hover:text-gray-600 font-ibm text-semibold"
                                        href="{{ url('/setting_profile') }}">จัดการบัญชี</p>
                                    </a>
                                </div>

                                <div class="mt-3 hover:bg-purple-100 px-3 py-1 rounded-xl cursor-pointer">
                                    <a class="hover:text-gray-600 font-ibm" href="{{ url('/') }}">ออกจากระบบ</a>
                                </div>
...
const image_user = document.querySelector('#image_user');
const menu_image_user = document.querySelector('#menu_image_user');

image_user.addEventListener('click', () => {
    menu_image_user.classList.toggle('hidden');
});
</script>
