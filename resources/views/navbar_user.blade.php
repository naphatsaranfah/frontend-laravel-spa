        ...
        ">
              ...
              md:pt-0 ">
                        ...
                        <li class="hidden  sm:block">
                            ...
                            <div class="mt-2 bg-white shadow-md rounded-xl p-4 my-3 absolute" id="menu_reserve_lg">
                        ...
                        <li class=" sm:hidden ">
                            ...
                            <div class="sm:hidden" id="menu_reserve">
                                <div class=" bg-white shadow-md w-full rounded-xl p-4 my-3">
                                    ...
                                    <a class="hover:bg-purple-100 p-3 rounded-xl cursor-pointer"
                                        href="{{ url('/aroma_oil') }}">
                                        <p class="hover:text-gray-600 font-ibm text-semibold">นวดน้ำมันอโรมา</p>
                                        <p class="text-xs font-ibm text-semibold">Get a better understanding of your
                                            traffic
                        ...
                        <li class="mt-3 ">
                            <a class="bg-fuchsia-900 px-5 py-2 rounded-lg hover:bg-purple-400 text-white  md:flex"
