            ...
            <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
              ...
              md:pt-0">
                    ...
                    <li class=" sm:hidden ">
                        ...
                        <div class=" hidden " id="menu_reserve">
                    ...
                    <li class="mt-3 ">
                        ...
                        <div class=" hidden mt-2  bg-white shadow-md rounded-xl p-4 my-3 absolute "
                            ...
                            <div class="hover:bg-purple-100 px-3 py-1 rounded-xl cursor-pointer">
                                <p class="hover:text-gray-600 font-ibm text-semibold"
                                    onClick="redirectToSetting_Profile()">จัดการบัญชี</p>
                                </p>
                            </div>

                            <div class="mt-3 hover:bg-purple-100 px-3 py-1 rounded-xl cursor-pointer">
                                <p class="hover:text-gray-600 font-ibm">ออกจากระบบ</p>
                            </div>
...
function redirectToSetting_Profile() {
