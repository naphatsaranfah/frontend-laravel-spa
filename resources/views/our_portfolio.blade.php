...
<body>
    ...
    <div class="container-our-portfolio ">
        ...
        <div class="card-our-portforio grid lg:grid-cols-2 sm:grid-cols-1 gap-5 py-10 mt-10">
            ...
            <img src="./images/portfolio-1.png" class="w-full rounded-xl">
        </div>
        ...
        <div class="card-our-portforio grid lg:grid-cols-2 sm:grid-cols-1 gap-5 py-10 mt-10">
            ...
            <img src="./images/portfolio-2.png" class="w-full rounded-xl">
        </div>


        <div class="card-our-portforio grid lg:grid-cols-2 sm:grid-cols-1 gap-5 py-10 mt-10">
            <img src="./images/portfolio-3.png" class="w-full rounded-xl">
