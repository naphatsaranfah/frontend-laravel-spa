        ...
        <div class="container-tab-all_my_reserve">
            ...
            <div
                ...
                <label for="service-success">
                    <span
                        class="py-4 px-5  gap-2 w-full text-center flex justify-center lg:rounded-r-2xl md:rounded-r-2xl sm:rounded-b-2xl">
                        <p class="text-header-tab-all_my_reserve">
                            ใช้บริการสำเร็จ
                        </p>
                    </span>
            ...
            <div class="p-5 rounded-lg shadow-md hidden tab-reserve-all">
                <div class="border-2 border-fuchsia-100 rounded-2xl p-5">
                    <div class="list-icon-header-details-user">
                        ...
                        <svg class="fill-fuchsia-900 cursor-pointer" data-modal-toggle="default-modal"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            style="transform: ;msFilter:;">
                            <path
                            ...
                            <div class="relative w-full max-w-2xl px-4 h-full md:h-auto ">
                                <div class="bg-white rounded-lg shadow-xl relative py-10">
                                    ...
                                    <div class="flex justify-center">
                                        <svg class="fill-fuchsia-900" xmlns="http://www.w3.org/2000/svg" width="64"
                                    ...
                                    <div class="mt-5">
                                        <h2 class="text-fuchsia-900 font-semibold text-lg text-center ">ต้องการลบการ
                                        </h2>
                                        <p class="text-fuchsia-900 font-semibold text-lg text-center ">นวดแบบเดี่ยว</p>
                                        <p class="text-fuchsia-900 font-semibold text-lg text-center ">คุณ นภัสรัญช์
                                            อินเทวา</p>
                                        <p class="text-fuchsia-900 font-semibold text-lg text-center ">วันที่ 12/10/66
                                    ...
                                    <div class="grid grid-cols-2 between gap-5 px-10">
                                        ...
                                        <button data-modal-toggle="default-modal" type="button"
                                            class="bg-fuchsia-900 text-white cursor-pointer py-2 px-10 rounded-lg mt-10">ตกลง</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="p-5 rounded-lg shadow-md hidden tab-outstanding">
                <div class="border-2 border-fuchsia-100 rounded-2xl p-5">
                    ...
                    <div class="container-btn-next ">
                        ...
                        <button onclick="redirectToPagePay()" class="btn-next ">ชำระเงิน</button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                            <div class="bg-white rounded-lg shadow-xl relative ">
                                <div class="flex items-start justify-between p-5 border-b rounded-t">
                                    <h3 class="text-fuchsia-900 text-xl lg:text-2xl font-semibold dark:text-white">
                                        Review
                                    </h3>
                                    <button type="button"
                                ...
                                <div class="px-20 py-2 space-y-6">
                                    <p class="text-fuchsia-900 font-semibold text-lg ">ให้คะแนน</p>
                                    ...
                                    <div class="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 gap-5 ">
                                        <div
                                            ...
                                            <div class="flex justify-center">
                                                <svg class="fill-fuchsia-800 hover:fill-fuchsia-900"
                                            ...
                                            <p class="text-center text-fuchsia-800 mt-2 font-semibold">ดีมาก</p>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <p class="text-center text-fuchsia-800 mt-2 font-semibold">พอใช้</p>
                                        </div>
                                        <div
                                            class="bg-white hover:bg-fuchsia-100 rounded-xl p-5  border-2 border-fuchsia-100">
                                            <div class="flex justify-center">
                                            ...
                                            <p class="text-center text-fuchsia-800 mt-2 font-semibold">แย่</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="px-20 py-2 gap-10">
                                    <label class="block text-fuchsia-900 font-semibold py-5" for="">
                                        ข้อเสนอแนะเพิ่มเติม
                                    </label><textarea id="message" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900   rounded-lg border-2 border-fuchsia-100 focus:ring-fuchsia-100 outline-fuchsia-400 focus:border-fuchsia-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="กรอกรายละเอียดเพิ่มเติม..."></textarea>

                                </div>

                                <div class="px-20 py-10 gap-10">
                                    <p class="text-sm text-fuchsia-900">ขอขอบคุณทุกคำติชมของคุณ
                                        เราจะนำไปพัฒนาระบบและการบริการให้ดียิ่งขึ้น</p>

                                    <button data-modal-toggle="default-modal-review" type="button"
                                        class=" mt-5 w-full text-white bg-fuchsia-900 hover:bg-fuchsia-700 focus:ring-4 focus:ring-fuchsia-100 font-medium rounded-lg text-sm px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-fuchsia-900 dark:focus:ring-fuchsia-100">ส่ง</button>
                                </div>
